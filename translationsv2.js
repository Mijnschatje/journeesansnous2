...
window.translations = {
  ...
  ar: {
    ...
    content: `
      ...
      <p dir="rtl"><strong>نص النداء:</strong></p>
      <p dir="rtl">هذا البلد لا يسير من دون المهاجرين، وهو قائم بفضل الهجرة ويستفيد منها في كلّ المجالات.</p>
      <p dir="rtl">الذي يدمّره ليس الهجرة بل السياسات المتّبعة والعنصرية والظلم.</p>
      <p dir="rtl">في 18 كانون الأوّل/ديسمبر، بمناسبة اليوم الدولي للمهاجرين، ندعو إلى إثبات ذلك.</p>
      <p dir="rtl">فلننظّم في كلّ أحيائنا وأماكن عملنا «يوماً بدوننا: إذا توقّفنا يتوقّف كلّ شيء».</p>
      <p dir="rtl">سواء بأوراق أم بدونها — مهاجرون/مهاجرات، أبناء/بنات مهاجرين من الجيل الأوّل والثاني والثالث، الأقارب والجيران والزملاء… لن نذهب إلى المدرسة أو إلى العمل أو التسوّق. سنسير معًا في كلّ مدن البلاد من أجل:</p>
      <ul dir="rtl">
